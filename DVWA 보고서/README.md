...
3. [모의해킹 검출 결과 요약](#3-모의해킹-검출-결과-요약)
4. [모의해킹 결과 상세](#4-모의해킹-결과-상세)
   - **핵심 취약점 6종 (전체 공개)**
...
화이트해커·네트워크 보안 전문가로 성장하기 위한 실습 과정에서, DVWA(Damn Vulnerable Web Application) 환경에 존재하는 주요 웹 취약점을 직접 점검·분석하고, 발생 원인과 파급 효과를 파악하여 개선 방안을 수립함으로써 실무 수준의 모의해킹 점검 역량을 검증하기 위함입니다.
...
| 구분 | 취약 항목 | 위험도 | 개수 |
|---|---|---|---|
| DVWA | SQL Injection | 상 | 1 |
| DVWA | Blind SQL Injection | 상 | 1 |
| DVWA | Command Injection | 상 | 1 |
| DVWA | CSRF | 상 | 1 |
| DVWA | XSS (Reflected) | 상 | 1 |
| DVWA | XSS (Stored) | 상 | 1 |
| DVWA | XSS (DOM) | 중 | 1 |
| DVWA | Brute Force | 상 | 1 |
| DVWA | File Upload | 상 | 1 |
| DVWA | File Inclusion (LFI/RFI) | 상 | 1 |
| DVWA | Insecure CAPTCHA | 중 | 1 |
| DVWA | Authorisation Bypass | 상 | 1 |
| DVWA | Weak Session IDs | 중 | 1 |
| DVWA | CSP Bypass | 중 | 1 |
| DVWA | JavaScript Attacks | 중 | 1 |
| DVWA | Open HTTP Redirect | 하 | 1 |
| DVWA | API Security (BOLA) | 상 | 1 |
| DVWA | Cryptography | 상 | 1 |

### 3.2. 총평

DVWA(Low 레벨)를 대상으로 모의해킹을 수행한 결과, 총 18개의 취약점이 발견되었습니다 (상 12건, 중 5건, 하 1건).
...
> 출처: [https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload](https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload) — 주요정보통신기반시설 기술적 취약점 분석·평가 방법 상세가이드 (p.693 ~ 699)
...
![02](img/sql-injection-02.png)  
![03](img/sql-injection-03.png)
...
![06](img/sql-injection-06.png)
![07](img/sql-injection-07.png)
...
![08](img/sql-injection-08.png)
![09](img/sql-injection-09.png)
...
![10](img/sql-injection-10.png)
![11](img/sql-injection-11.png)
...
![13](img/sql-injection-13.png)
![14](img/sql-injection-14.png)
...
> 출처: [https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload](https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload) — 주요정보통신기반시설 기술적 취약점 분석·평가 방법 상세가이드 (p.711 ~ 714)
...
<img src="img/authorisation-bypass-01.png" width="100%">
...
<img src="img/authorisation-bypass-02.png" width="100%">
...
<img src="img/authorisation-bypass-03.png" width="100%">
...
<img src="img/authorisation-bypass-04.png" width="100%">
...
<img src="img/authorisation-bypass-05.png" width="100%">
...
<img src="img/file-inclusion-01.png" width="100%">

- `File1.php, File2.php, File3.php` 파일을 클릭하여 확인합니다.

###### File1.php 화면

<img src="img/file-inclusion-02.png" width="100%">

###### File2.php 화면

<img src="img/file-inclusion-03.png" width="100%">

###### File3.php 화면

<img src="img/file-inclusion-04.png" width="100%">
...
<img src="img/file-inclusion-05.png" width="100%">
...
<img src="img/file-inclusion-06.png" width="100%">
...
<img src="img/file-inclusion-07.png" width="100%">
<img src="img/file-inclusion-08.png" width="100%">
...
<img src="img/file-inclusion-09.png" width="100%">
...
<img src="img/file-inclusion-10.png" width="100%">
...
![01](img/blind-sql-injection-01.png)
...
![02](img/blind-sql-injection-02.png)
...
![03](img/blind-sql-injection-03.png)
...
- 결과 데이터가 직접 출력되지 않더라도 참/거짓 응답 차이를 이용해 데이터 추론이 가능합니다.
...
![04](img/blind-sql-injection-04.png)
...
![05](img/blind-sql-injection-05.png)

- 존재하지 않는 User ID에 대해서는 시간 지연이 발생하지 않고 빠르게 응답하는 것을 확인했습니다.
- 조건이 참일 때만 지연이 발생하는 Time-based Blind SQL Injection이 가능합니다.
...
![06](img/blind-sql-injection-06.png)
![07](img/blind-sql-injection-07.png)
...
![08](img/blind-sql-injection-08.png)

- 실행 결과 dvwa와 information_schema 데이터베이스가 확인되었습니다.
- Blind SQL Injection 환경에서도 Database 이름을 추출할 수 있습니다.
...
![09](img/blind-sql-injection-09.png)
...
![10](img/blind-sql-injection-10.png)
...
> 출처: [https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload](https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload) — 주요정보통신기반시설 기술적 취약점 분석·평가 방법 상세가이드 (p.679 ~ 692)
...
![01](img/command-injection-01.png)
...
![02](img/command-injection-02.png)
...
![03](img/command-injection-03.png)
...
![04](img/command-injection-04.png)
...
- 소스코드를 보면 `$_REQUEST['ip']`로 입력값을 받아 아무런 검증 없이 `shell_exec()`에 직접 연결합니다.
...
> 출처: [https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload](https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload) — 주요정보통신기반시설 기술적 취약점 분석·평가 방법 상세가이드 (p.715 ~ 718)
...
<img src="img/csrf-01.png" width="100%">
...
<img src="img/csrf-02.png" width="100%">
...
<img src="img/csrf-03.png" width="100%">
...
<img src="img/csrf-04.png" width="100%" height="480">

- 본 실습에서 개인의 이메일로 전송하여 하이퍼 링크를 클릭하였습니다.

<img src="img/csrf-05.png" width="100%">

---

##### 공격 성공 확인

<img src="img/csrf-06.png" width="100%">
...
- `maxlength=50`으로는 페이로드 전체를 입력할 수 없어 개발자 도구에서 직접 값을 `500`으로 수정했습니다.

```html
<textarea name="mtxMessage" cols="50" rows="3" maxlength="500"></textarea>
```

![03](img/xss-stored-03.png)

- `maxlength` 값 수정 후 페이로드 전체 입력이 가능해진 것을 확인했습니다.
- 이처럼 클라이언트 사이드에서만 길이 제한을 두는 경우 개발자 도구를 통해 손쉽게 우회가 가능합니다.
- 서버 사이드에서도 입력값 길이 검증이 반드시 병행되어야 합니다.
- 소스코드를 보면 입력값에 대한 HTML 필터링이 전혀 없습니다.
...
- 입력값이 HTML 인코딩 없이 DB에 그대로 저장되고 있습니다.
...
![04](img/xss-stored-04.png)
![05](img/xss-stored-05.png)
...
- `/cookie` 경로가 서버에 존재하지 않아 404가 반환되었지만,  
  쿠키 값(`PHPSESSID=1af2f54f6bc67d09e94defecb70a327d`)이 URL에 포함되어 서버 로그에 기록된 것을 확인했습니다.
- XSS 탭을 열 때마다 동일한 로그가 반복 기록되어 스크립트가 DB에 영구 저장되어 지속 실행됩니다.
...
![06](img/xss-stored-06.png)

- 초기화 이후 XSS (Stored) 페이지에 재접속하면 저장된 스크립트가 삭제되어 더 이상 실행되지 않는 것을 확인했습니다.

![07](img/xss-stored-07.png)

- Stored XSS의 지속성과 DB 초기화를 통한 제거 방법을 확인했습니다.
...
<img src="img/brute-force-01.png" width="100%">
...
<img src="img/brute-force-02.png" width="100%">
...
<img src="img/brute-force-03.png" width="100%">
...
<img src="img/brute-force-04.png" width="100%">
...
<img src="img/brute-force-05.png" width="100%">
...
<img src="img/brute-force-06.png" width="100%">
...
<img src="img/brute-force-07.png" width="100%">
...
<img src="img/insecure-captcha-01.png" width="100%">
...
<img src="img/insecure-captcha-02.png" width="100%">
...
<img src="img/insecure-captcha-03.png" width="100%">
...
<img src="img/insecure-captcha-04.png" width="100%">
...
<img src="img/insecure-captcha-05.png" width="100%">
...
<img src="img/insecure-captcha-06.png" width="100%">
...
<img src="img/insecure-captcha-07.png" width="100%">
...
<img src="img/insecure-captcha-08.png" width="100%">
...
> 출처: [https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload](https://www.kisa.or.kr/2060204/form?postSeq=22&page=1#fnPostAttachDownload) — 주요정보통신기반시설 기술적 취약점 분석·평가 방법 상세가이드 (p.759~762)
...
<img src="img/weak-session-ids-01.png" width="100%">
...
<img src="img/weak-session-ids-02.png" width="100%">
...
<img src="img/weak-session-ids-03.png" width="100%">
...
<img src="img/weak-session-ids-04.png" width="100%">
...
<img src="img/csp-bypass-01.png" width="100%">
...
<img src="img/csp-bypass-02.png" width="100%">
...
<img src="img/csp-bypass-03.png" width="100%">
...
<img src="img/csp-bypass-04.png" width="100%">

- Include 클릭 결과 `CSP Bypassed` 문자열이 담긴 alert 팝업이 실행되는 것을 확인할 수 있습니다.

<img src="img/csp-bypass-05.png" width="100%">
...
<img src="img/csp-bypass-06.png" width="100%">
...
<img src="img/javascript-attacks-01.png" width="100%">
...
<img src="img/javascript-attacks-02.png" width="100%">
...
<img src="img/javascript-attacks-03.png" width="100%">
...
<img src="img/javascript-attacks-04.png" width="100%">
...
<img src="img/javascript-attacks-05.png" width="100%">
...
<img src="img/javascript-attacks-06.png" width="100%">
...
<img src="img/javascript-attacks-07.png" width="100%">
...
<img src="img/javascript-attacks-08.png" width="100%">
...
<img src="img/open-http-redirect-01.png" width="100%">
...
<img src="img/open-http-redirect-02.png" width="100%">
...
<img src="img/open-http-redirect-03.png" width="100%">
...
<img src="img/open-http-redirect-04.png" width="100%">
...
<img src="img/open-http-redirect-05.png" width="100%">
...
<img src="img/open-http-redirect-06.png" width="100%">
...
<img src="img/open-http-redirect-07.png" width="100%">
...
![03](img/cryptography-03.png)

---

##### 로그인 성공 확인

![04](img/cryptography-04.png)
