...
- `dbconn.php`, `login_process.php`, `register_process.php`, `upload_process.php`, `write_process.php` 백엔드 코드 전체 직접 작성
...
게시판 파일 업로드 기능에서 `.php` 확장자를 블랙리스트로 막고 있었는데,
Burp Suite로 요청을 가로채 확장자를 `&#x70;&#x68;&#x70;` 형태로 바꿔서 올렸더니 그냥 통과됐습니다.
